...
public class NPCActionManager : MonoBehaviour
{
    ...
    private void test()
    {
        ...
        monparam8.Put("t", "mi");
        monparam8.Put("v", "300");
        monparam8.PutNumber("m", 0);
        SFSObject monparam9 = new SFSObject();
        monparam9.Put("n", "monparam9");
        monparam9.Put("t", "am");
        monparam9.PutNumber("o", (int)ActionMark.OwnerType.PLAYER);
        monparam9.Put("na", "monwaypoint");
            ...
            {             
                ...
                switch (paramType)
                {
                    ...
                    case "am"://actionMark (an absolute position or the position of a physical entity marked by the player or his faction)
                        ActionMark.OwnerType ownerType = (ActionMark.OwnerType)param.GetNumber("o");
                        string actionMarkName = param.GetString("na");
                        action.AddActionMark(paramName, ownerType, actionMarkName);
                        break;
